...
Đến cuối phần này, bạn sẽ có thể tạo và gửi các Versioned Transaction, giúp gia tăng khả năng xây dựng các ứng dụng Solana phức tạp và hiệu quả hơn.  
Bắt đầu thôi! 🚀📦
...
4. **Viết các bài Kiểm tra**  
   Như thường lệ, hãy viết các bài kiểm tra:
